...
const floor1Apartments = [
  ...
  seed({
    ...
    planQuality: "typology",
    modelLabel: "Typologie Vorderhaus links",
  }),
  seed({
    code: "WE 05",
    highlightCode: "WE 04",
  ...
  seed({
    ...
    planQuality: "typology",
    modelLabel: "Typologie Vorderhaus rechts",
  }),
  seed({
    code: "WE 19",
    highlightCode: "WE 22",
...
const floor2Apartments = [
  ...
  seed({
    ...
    cadPlanSrc: cadPlans.apt2SflRight,
    planQuality: "exact",
    modelLabel: "Vorderhaus rechts, 2. Obergeschoss",
  }),
  seed({
    code: "WE 26",
    highlightCode: "WE 29",
...
const floor3Apartments = [
  seed({
    ...
    title: "5-Zimmer-Wohnung im Vorderhaus",
    section: "Vorderhaus",
    position: "Vorderhaus rechts",
    sqm: 178.9,
    rooms: 5,
